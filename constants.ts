...
export const SYMPOSIUM_PASSES: SymposiumPass[] = [
  ...
  },
  {
    ...
    priceDisplay: '₹250',
    priceNote: '₹250 / person (1 Tech + 1 Non-Tech FREE)',
    offerDetails: 'Register for ₹250/person: Select 1 Technical Event and get 1 Non-Technical Event completely FREE!',
    features: [
...
export const EVENTS: Event[] = [
  ...
  // ==========================================
  {
    ...
    maxMembers: 4,
    fee: 250,
    feeDisplay: "₹250 (1 Tech + 1 Non-Tech FREE)",
    feeNote: "AURA Pass: ₹250 / person includes 1 Technical Event + 1 Non-Technical Event completely FREE!",
  ...
  // ==========================================
  {
    ...
    maxMembers: 4,
    fee: 250,
    feeDisplay: "FREE with Tech / ₹250",
    feeNote: "AURA Pass: 100% FREE when paired with any Technical Event, or ₹250 individual pass",
